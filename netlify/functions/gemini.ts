  ...
  if (event.httpMethod !== "POST") {
    ...
    try {
      ...
      let promptText = `
        ...
        זהה תבניות משמעותיות, נקודות עיוורות (פער בין תפיסה עצמית לסביבה), ועוצמות שקופות (חוזקות שהמשתמש לוקח כמובן מאליו).
        הפק דוח מעמיק, רגיש ואופרטיבי. 
        **חשוב מאוד: אל תזכיר שום מבחן אישי או מותג אבחון בשום מקום בדוח אלא אם סופק כזה ספציפית על ידי המשתמש.**
      ...
      if (fileData) {
        promptText = `
          ...
          **שים לב: מצורף קובץ אבחון אישי (PDF) עבור המשתמש.**
          עליך לבצע אינטגרציה מלאה בין המידע ממשובי ה-360 לבין המידע מתוך האבחון האישי המצורף:
          ...
          3. **אינטגרציה מעמיקה**: התייחס למאפיינים הספציפיים שעולים מהאבחון האישי ושלב אותם בתובנות.
